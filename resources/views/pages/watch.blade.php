    ...
    <div class="row container" id="wrapper">
        <div class="halim-panel-filter">
            <div class="panel-heading">
                <div class="row">
                    <div class="col-xs-6">
                        <div class="yoast_breadcrumb hidden-xs"><span><a href="#">» {{$movie->category->title}}</a><span><a href="#"><span>» {{$movie->country->title}}<span></a><a href="{{ route('movie', $movie->slug) }}"> » {{$movie->title}}</a></span></span></div>
                    </div>
                </div>
            </div>
