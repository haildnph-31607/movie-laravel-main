...
<body class="home blog halimthemes halimmovies" data-masonry="" style="position: relative;">
    <header id="header">
        <div class="container">
            <div class="row" id="headwrap">
                    ...
                    <div class="header-nav">
                        <div class="col-xs-12">
                                ...
                                <div class="input-group col-xs-12 position-relative">
                                    <form action="{{route('search')}}" method="GET">
                                        ...
                                        <input id="timkiem" type="text" name="search"
                                            class="form-control changeForm" placeholder="Tìm kiếm..." autocomplete="off"
                                            required>
                                        {{-- <ion-icon name="aperture-outline" class="animate-spin"></ion-icon> --}}
                                        <button class="btn btn-primary search-outline" name=""><ion-icon
                            ...
                            <ul class="list-group" id="result"
                                style="display: none; position: absolute; background-color: #1f3d58 ; z-index: 20; height: 600px ; overflow-y: auto;  ">
                ...
                <div class="col-md-4 hidden-xs">
                    <div id="get-bookmark" class="box-shadow"><ion-icon name="star-outline"></ion-icon><span>
                    ...
                    <div class="menu-menu_1-container">
                        <ul id="menu-menu_1" class="nav navbar-nav navbar-left">
                            <li class="current-menu-item active"><a title="Trang Chủ"
                                    href="{{ route('homepages') }}">Trang Chủ</a></li>
                            @isset($category)
            ...
            <div class="row container">
                <div class="widget about col-xs-12 col-sm-4 col-md-4">
                    ...
                    Liên hệ QC: <a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                        data-cfemail="e5958d8c888d849ccb868aa58288848c89cb868a88">[email&#160; :
                        nguyenminhkhong2004@gmail.com]</a>
                </div>
            </div>
        </div>
    </footer>
    ...
    <script type="text/javascript">
        $(".scroll-trailer").click(function(e) {
            e.preventDefault();
                        ...
                        $.getJSON('./public_json/compare.json', function(data) {
                            $.each(data, function(key, value) {
                                if (value.title.search(expression) != -1) {
                                    ...
                                    $('#result').append(
                                        '<li style="cursor:pointer; display: flex; max-height: 200px; width:400px;" class="list-group-item link-class"><img src="uploads/movie/' +
                                        value.image +
